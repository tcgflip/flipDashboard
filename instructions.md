...
- The product name is **"Poke Fips"** — not a typo for "Poke Flips." The wordmark stylizes it as `poke` + a visually-flipped `fips` (the whole point of the mark is that second word turning over). Don't "correct" it — a run already did this once (2026-09-15) and had to be reverted.
