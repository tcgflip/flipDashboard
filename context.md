...
_Last researched: 2026-09-17 (weekly deep dive; see run-log.md)._
...
- **Shop trade nights worth watching**: ToyLynx Trade Night (recurring, 2nd & 4th Thursdays, Iwilei Rd, Honolulu — Sept 10/24, Oct 8/22 2026, no fee, no vendor tables, confirmed via toylynx.com/events); TCG Tavern Trade Day (903 Isenberg St — Oct 26 2026, confirmed via Instagram). "Uncle Tony's Trade Night at Pearlridge" — **flagged 2026-09-14 as possibly stale/unconfirmable**: could not find independent evidence this is a real, separately-scheduled event distinct from 808 Showcase Trade Night (same venue, same 3rd-Friday-ish cadence) — may be a naming mixup from an earlier run. Don't treat as actionable until confirmed firsthand (call the shop or check Instagram directly — not reachable via this session's web tools). "Mini Pokemon Market at FilCom Center, Waipahu" — **flagged 2026-09-14 as unconfirmed**: no evidence found at all for this event under that name; dropped from active tracking pending a firsthand source.
- **Urban Soccer Hawaii Card Show** — 218 Mohonua Pl, Honolulu — CONFIRMED 2026-09-14: next date is **Sept 26 2026** (not Sept 27 as previously estimated), with a bonus second date **Oct 31 2026** at the same venue (both via tcdb.com and hawaiicardshows.com).
- **NEW (found 2026-09-14 weekly deep dive) — Space 62 Collectibles Show** — Ala Moana Center Annex, Upper Level (Space 62's dedicated TCG room) — periodic (not confirmed monthly), most recently ran June 26-28 2026 (~60 vendors, $5/weekend or canned-food donation, free Friday trade night). No Sept/Oct 2026 date confirmed yet — monitor hawaiicardshows.com/shops/space-62 for a fall date before treating as actionable.
- **NEW (found 2026-09-15 daily check) — Aloha Comic Con Card Pavilion** — Hawaii Convention Center — a card-focused pavilion inside "Amazing Comic Con Aloha," ran Sept 12 2026 (already past by the time this was found, not actionable this cycle). Not yet confirmed whether it's an annual/recurring fixture — check amazingcomicconaloha.com for a 2027 date before adding to the active show calendar.

Confirmed dates as of this run (verify again before acting — schedules move): Aloha Card Show Sept 19-20 2026 (Blaisdell, 10am-6pm, $10/day); 808 Showcase Trade Night Sept 18/Oct 16/**Nov 20** 2026 (Pearlridge); Urban Soccer Hawaii Card Show Sept 26/Oct 31/**Nov 28** 2026 (218 Mohonua Pl); Pokémon, Sports Cards & More Sept 27 2026 (Ala Moana Hotel), Oct 25 2026 (Prince Waikiki), and **~Nov 29 2026** (venue not yet named); Keep It Aloha Oct 3-4 2026 (SALT); Sports Cards & Collectibles Show ~Oct 10-11 2026 (Pearlridge, 2nd weekend monthly pattern confirmed and corroborated by a second aggregator this run, October date still not individually listed by venue's own name); 808 Cards and Collectibles Show + Paradise Card Show both Oct 18 2026 (real same-day conflict, confirmed both sides — pick one); Spotlight Card Show Oct 24-25 2026 (Hawaii Convention Center); Bayview Night Market Oct 6/20, **Nov 3/17** 2026 (Kāneʻohe); West Side Card Show Dec 5-6 2026 (Kroc Center, **Kapolei** — corrected from Kāneʻohe, see above).

**UPDATE (2026-09-17 weekly deep dive):** All shows above reconfirmed unchanged where a prior date existed; November dates added where found (see bolded additions). One ambiguity found and not resolved: search results for Urban Soccer Hawaii Card Show also surfaced a "Nov 1 2026" date one day after the confirmed Oct 31 date — this may be a 2-day Oct 31-Nov 1 event rather than two separate shows; not adding Nov 1 as a distinct entry until clarified. "Uncle Tony's Trade Night at Pearlridge" — checked again, still no independent evidence of a separately-scheduled event; every hit describes the same 3rd-Friday slot as 808 Showcase Trade Night, so treating this as just an informal alt-name for that event rather than tracking it separately going forward. Space 62 Collectibles Show — still no fall 2026 date found (last confirmed run was June 2026). Aloha Comic Con Card Pavilion — searches only surface older (2024-era) dates with no fixed annual pattern; no 2027 date exists yet to track.
...
- **Aloha Card Shop** — Pokémon sealed/singles/sports; also sells online (alohacardshop.com, eBay store "alohatcg"); ~1,847 Pokémon SKUs listed online as of the 2026-09-13 daily check. **UPDATE (2026-09-17 weekly deep dive): 30th Celebration listings now confirmed live** — multiple SKUs found (Knock Out Collection, Poster Collection, Elite Trainer Box, Tech Sticker Collection, Sylveon ex/Greninja ex Box), resolving the "none confirmed" flag standing since 2026-09-13. Note: a Yelp listing shows an Aloha Card Shop location at 1450 Ala Moana Blvd (Space 62 building) marked CLOSED as of Sept 2026 — their Ward Ave, Windward Mall, and Kahala Mall locations remain listed as open.
...
- **NEW (2026-09-14 weekly deep dive) — network egress note**: this run's environment blocked WebFetch/curl entirely for nearly every pricing domain (tcgplayer.com, pricecharting.com, pokemontcg.io API, pokescope.app, thelabtcg.com, tcgtalk.com, pokemonpricetracker.com, and even hawaiicardshows.com/cutterscollection.com/etc. for the show-calendar research) — confirmed via direct 403/EGRESS_BLOCKED responses. WebSearch (routes through a different backend) still worked and was used for everything this run, cross-checking multiple source snippets per figure where possible. This is a worse position than prior runs that could at least WebFetch some of these — worth flagging to Ryan if it persists, since it caps price-verification confidence to "WebSearch-snippet-sourced," not "directly fetched."
...
- **UPDATE (2026-09-17 weekly deep dive)**: egress restriction persists, no change — api.pokemontcg.io, tcgplayer.com, sportscardinvestor.com, pokescope.app, alohacardshop.com, hawaiicardshows.com, cutterscollection.com, and alohacardshow.com all returned EGRESS_BLOCKED on direct WebFetch this run. WebSearch remains the only usable research path.
- **Sourcing technique note (found 2026-09-17)**: when a card's name collides with other prints of the same Pokémon (e.g. "Umbreon VMAX" matching multiple different Evolving Skies prints — the non-alt-art #095/203, the Secret Rare #214/203, and the "Moonbreon" alt-art secret #215/203, which is worth 10-50x more), a generic eBay/name search returns a contaminated, unusably wide price spread. Searching a **per-print price-guide page keyed to the exact card ID** (e.g. Poke Plug, TCGFish — URLs like pokeplug.io/cards/&lt;name&gt;-&lt;setcode&gt;-&lt;number&gt;/) isolates the specific print cleanly. Use this when a name search comes back with an implausibly wide or bimodal price range instead of concluding the data is just unusable.
